    ...
    <div className=" absolute flex h-screen w-screen items-center justify-center">
      ...
      >
        <div
          ...
          id="slideover-bg"
          className="absolute inset-0 h-full w-full bg-gray-900 opacity-0 transition-all duration-500 ease-in-out"
        ></div>
        <div
          onClick={toggleSlideover}
          id="slideover"
          className="absolute right-0 h-full w-screen translate-x-full bg-white transition-all duration-300 ease-in-out md:w-96"
        >
